    ...
    return (
        ...
        >
            ...
            <p className="modal-instructions">
                Insert the address of the account to be proposed as a new owner
                according to the example. Hit the submit button to add a new
                transaction to the pending list.
            </p>
